...
class HomePageView(View):
    ...
    def get(self, request):
        # If authenticated and doctor/patient, show positive feedback
        if request.user.is_authenticated:
            user_role = request.user.profile.role if hasattr(request.user, 'profile') else None
            if user_role in ['user', 'patient']:  # Doctor or Patient
                # Get positive feedback for display
                ...
                return render(request, "home.html", {
                    ...
                    'show_feedback_home': True
                })

        # For non-authenticated, admin, technician - show landing page
        return render(request, "home.html", {'show_feedback_home': False})
